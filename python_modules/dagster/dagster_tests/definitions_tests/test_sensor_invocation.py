...
from dagster import (AssetIn, AssetKey, AssetOut, AssetSelection,
                     BoolMetadataValue, DagsterEventType, DagsterInstance,
                     DagsterInvariantViolationError, DagsterRunStatus,
                     DailyPartitionsDefinition, EventRecordsFilter,
                     FreshnessPolicy, Output, PartitionKeyRange,
                     PartitionMapping, PartitionsDefinition, RunRequest,
                     SensorEvaluationContext, SkipReason,
                     StaticPartitionsDefinition, asset,
                     build_freshness_policy_sensor_context,
                     build_multi_asset_sensor_context,
                     build_run_status_sensor_context, build_sensor_context,
                     define_asset_job, freshness_policy_sensor, job,
                     materialize, multi_asset, multi_asset_sensor, op,
                     repository, run_failure_sensor, run_status_sensor, sensor)
...
def test_build_multi_asset_sensor_context_asset_selection():
    from dagster_tests.asset_defs_tests.test_asset_selection import (alice,
                                                                     bob,
                                                                     candace,
                                                                     danny,
                                                                     edgar,
